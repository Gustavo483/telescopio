...
<body class="container">
    ...
    <form method="post" action="{{ route('update.QuestaoME', ['IDQuestao' =>$Questao->id])}}">
        ...
        <input type="number" name="st_gabarito" value="{{ $Questao->st_gabarito?? old('st_gabarito') }}" placeholder="Digite o número da atividade que está correta">
        <div>
