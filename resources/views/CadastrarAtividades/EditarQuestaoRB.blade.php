...
@section('conteudo')
    ...
    <div class="flexPAluno mt-3 ">
        <h4 class="h4Pets">
            Painal do Administrador > Unidades > Conteudos > Editar questão  RB
        </h4>
    ...
    <h3 class=" mt-5 h4Pets text-center mb-5">
        Editar questão de resposta breve para o conteúdo {{$conteudo->st_nome_conteudo}}
    </h3>

    <form method="post" action="{{ route('update.QuestaoRB', ['IDQuestao' =>$Questao->id])}}">
        @csrf
        @method('PUT')
