            ...
            <tr class="border12">
                ...
                <td>
                    @if($questao->st_tipoDeQuestao == 'questaoME')
                        <a href="{{route('editar.QuestaoME',['IDQuestao'=>$questao->id])}}">editar</a>
                    @endif
                    @if($questao->st_tipoDeQuestao == 'questaoRB')
                        <a href="{{route('editar.QuestaoRB',['IDQuestao'=>$questao->id])}}">editar</a>
                    @endif
                    @if($questao->st_tipoDeQuestao == 'questaoRN')
                        <a href="{{route('editar.QuestaoRN',['IDQuestao'=>$questao->id])}}">editar</a>
                    @endif
                </td>
