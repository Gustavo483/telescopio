...
@section('conteudo')
    <div class="flexPAluno mt-3 ">
        <h4 class="h4Pets">
            Painal do Administrador > Unidades > Conteudos > vizualizar teste final do curso
        </h4>
    ...
    @if(isset($dados))
        <h3 class=" mt-5 h4Pets text-center">
            Relação de conteudos para o teste final {{$dados[0]->cursos->st_nome_curso}}
        </h3>

        <a class="btnVoltar text-center" href="{{route('edit.ConteudoTesteFinalCurso',['dadosconteudo'=>$dados[0]->fk_conteudo_pertencente, 'fkCurso'=>$dados[0]->fk_curso])}}">
            Editar
        </a>
    @endif

    <div class="d-flex justify-content-center my-5">
        <table id="myTable3" class="mb-5 mt-5">
            <thead>
            <tr class="border12">
