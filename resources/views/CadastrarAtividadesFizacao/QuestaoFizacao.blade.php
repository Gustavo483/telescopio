...
<div>
    <h4 class="mt-5 mb-2">
        Cadrastro de atividade de fização para o conteudo {{$dadosconteudo->st_nome_conteudo}}
    </h4>
</div>

<div>

    <h5>Selecione o tipo de atividade</h5>
    ...
    <button id="btnTipoAtividade">Selecionar</button>
</div>
<div id="divME" class="none">
    ...
    <form method="post" action="{{route('StoreQuestaoFZME.conteudo', ['dadosconteudo'=>$dadosconteudo])}}">
        ...
        <label class="mt-5" for="">Banca atividade</label>
        <input type="text" name="DadosBanca">
        <div>
        ...
        <input type="number" name="st_gabarito" value="{{ old('st_gabarito') }}"
...
<div id="divRN" class="none">
    ...
    <form method="post" action="{{route('StoreQuestaoFZRN.conteudo', ['dadosconteudo'=>$dadosconteudo])}}">
        ...
        <label class="mt-5" for="">Resposta da atividade:</label>
        <input type="text" name="st_respostaRN">
        <div>
