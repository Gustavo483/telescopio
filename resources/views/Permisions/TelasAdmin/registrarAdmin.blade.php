...
@section('conteudo')
    <div class="flexPAluno mt-3 ">
        <h4 class="h4Pets">
            Painal do Administrador > {{$Admin->st_nome_admin}} > Cadastro de Administrador
        </h4>
    ...
    <div class="flexRegisterAluno mb-5">
        <div class="FormCadastro">
            <form action="{{route('registerAdminStore')}}" method="post">
                @csrf
                <div class="hsd2">
                ...
                <div class="p-3">
                    ...
                    <input class="form-control" type="text" name="name" value="{{ old('name') }}" placeholder="Digite o nome do Administrador:">
                    <div class="errosd">
                    ...
                    <div class="d-flex justify-content-center align-items-center mt-4">
                        <button class="btnVoltar4" type="submit">Cadastrar Administrador</button>
                    </div>
                </div>
            </form>
        </div>
