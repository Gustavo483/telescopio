...
@section('infoPágina', 'Painel do professor > '.$IDCurso->st_nome_curso.' > '.$Aluno->st_nome_aluno.' > Tarefas')

@section('conteudo')

    <h5 class="text-center mt-5 h4Pets">Tarefas do aluno no curso "{{$IDCurso->st_nome_curso}}"</h5>
